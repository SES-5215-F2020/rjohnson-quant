...
I took the difference between observed and expected values from the chi-squared test, and used the results to define a new data frame **C_diff_data**. I then plot this data frame as a heatmap, with the two variables on the axes and the difference as the fill, to visualize the distribution of households by age of construction and household type. 
...
```{r histogram of above, message=FALSE}
