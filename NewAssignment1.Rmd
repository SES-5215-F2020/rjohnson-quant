...
Next, I filtered this data to create my desired sample. To accomplish this, I included the variable "PUMA", which includes a 5-digit Public Use Microdata Area code. These codes area assigned to areas including roughly 100,000 people, and are coded at the county level. I used the Census Bureau website's Geography web map (https://tigerweb.geo.census.gov/tigerweb/) to find all of the codes included within Travis County. 
...
```{r load household-level MA data filtered, message=FALSE, include=FALSE, results='hide'}
...
hh_TravisCo_data <- get_pums(variables = c("PUMA", 
                        ...
                        survey = "acs1",
                        recode = TRUE) %>%
     filter(HINCP > 12140, RNTP > 0 | MRGP >0, PUMA=='05301' | PUMA=='05302' | PUMA=='05303' | PUMA=='05304' | PUMA=='05305' | PUMA=='05306' | PUMA=='05307' | PUMA=='05308' | PUMA=='05309') %>%
     select(HINCP, RNTP, MRGP, NP, HHT_label, TEN_label, YBL_label)
```
